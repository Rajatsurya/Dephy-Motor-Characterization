...
# Load the CSV file
file_path = "New_Actpack9to1_Characterization_ankle_250228_024002.csv"
df = pd.read_csv(file_path)

# Extract relevant columns
current_column = "ankle[DephyActpack]:motor_current"  # Motor current (Iq)
torque_column = "torque"  # Torque (τ)
motor_position_column = "ankle[DephyActpack]:motor_position"  # Motor position
motor_velocity_column = "ankle[DephyActpack]:motor_velocity"  # Motor velocity
