...
file_path = "New_Actpack9to1_Characterization_knee_250228_024845.csv"
df = pd.read_csv(file_path)
...
V_torque = df[torque_column].values  # Torque in volts (or Nm if calibrated)
...
τ = (V_torque * CALIBRATION_FACTOR) / GEAR_RATIO
